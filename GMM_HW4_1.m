...
%X1 = [mvnrnd(mu_true(1,:),Sigma_true(:,:,1),100*beta_true2(1)); mvnrnd(mu_true(2,:),Sigma_true(:,:,2),100*beta_true2(2)); mvnrnd(mu_true(3,:),Sigma_true(:,:,3),100*beta_true3(3))];
X1 = [mvnrnd(mu_true(1,:),Sigma_true(:,:,1),100*beta_true3(1)); mvnrnd(mu_true(2,:),Sigma_true(:,:,2),100*beta_true2(2)); mvnrnd(mu_true(3,:),Sigma_true(:,:,3),100*beta_true3(3))];
